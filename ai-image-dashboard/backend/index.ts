    ...
    if (process.env.REPLICATE_API_TOKEN && frontPath && backPath) {
      ...
      try {
        ...
        return res.json({
          ...
          images: [
            { type: 'Front Angle Image', url: (frontRes as any)[0] },
            { type: 'Right Angle Image', url: (rightRes as any)[0] },
            { type: 'Left Angle Image', url: (leftRes as any)[0] },
            { type: 'Back Angle Image', url: (backRes as any)[0] }
          ]
        });
