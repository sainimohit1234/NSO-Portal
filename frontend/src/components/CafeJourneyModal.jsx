...
const STAGES = [
  {
    ...
    trigger: 'Manual — Admin adds a new café to the Expansion Pipeline',
    description: 'A new café location is identified and added to the Expansion Pipeline module. Basic details are entered: café name, brand, city, state, café model, and address. This is the earliest stage of a new store lifecycle.',
    conditions: 'Café Name must be filled. Café Code and LOI document not yet required.',
    emailTrigger: false,
    ...
    actions: [
      ...
      'Fill café name, brand, city, state, café model, and address',
      'Save — store is created with status: In Pipeline',
      'Store appears in the Expansion Pipeline table',
    ],
    fields: ['Café Name', 'Brand', 'City', 'State', 'Café Model', 'Address'],
  },
  {
    id: 'agreement',
    step: 2,
    ...
    trigger: 'Automatic — when LOI document is uploaded but Café Code is not yet assigned',
    description: 'The Letter of Intent (LOI) or agreement document is uploaded to the pipeline entry, confirming the café location has been secured. The store has an agreement in place but construction has not yet been authorized.',
    conditions: 'LOI/Agreement document is uploaded. Café Code is NOT yet assigned.',
    emailTrigger: false,
    nextStage: 'Ready for Construction',
    nextCondition: 'Café Code is assigned AND LOI document is uploaded.',
    actions: [
      ...
      'Café Code not yet assigned — construction not yet authorized',
    ],
  ...
  },
  {
    ...
    trigger: 'Automatic — when Café Code is assigned AND LOI document is uploaded',
    description: 'The café has been officially assigned a Café Code and an agreement is in place. The project is now authorized to begin construction. This status can also be triggered manually via the status dropdown in the pipeline.',
    conditions: 'Café Code is assigned AND LOI document is uploaded.',
    emailTrigger: true,
    ...
    actions: [
      'Café Code is assigned (auto-triggers status upgrade)',
    ...
    fields: ['Café Code', 'LOI Document', 'Budget Document'],
  },
  {
    ...
    description: 'The physical café space is actively being built and fitted out. All construction, interior design, equipment installation, and compliance work is happening during this stage.',
  ...
  },
  {
    ...
    actions: [
      ...
      'Fills all required fields: café name, code, contacts, GST, FSSAI, model, etc.',
    ...
    fields: ['Café Name', 'Café Code', 'Brand', 'GST No.', 'FSSAI License', 'City Head', 'Area Manager', 'Café Manager', 'RIDs (Swiggy/Zomato)', 'Project Dates'],
  },
  {
    id: 'pending_approval',
    step: 6,
  ...
  },
  {
    ...
    module: 'Swiggy / Zomato Integration',
    ...
    actions: [
      'Open Swiggy / Zomato Integration module',
  ...
  },
  {
    ...
    description: 'The store is now live on delivery platforms (Swiggy/Zomato). The Delivery Live toggle is enabled with the delivery start date. Customers can now place delivery orders from this café.',
...
const STATUS_REFERENCE = [
  { label: 'In Pipeline', color: '#6366f1', bg: 'rgba(99,102,241,0.12)', border: 'rgba(99,102,241,0.3)', desc: 'Earliest stage. Café location identified, basic info entered in the Expansion Pipeline module.' },
  { label: 'Agreement Signed', color: '#8b5cf6', bg: 'rgba(139,92,246,0.12)', border: 'rgba(139,92,246,0.3)', desc: 'LOI/agreement document uploaded. Café Code not yet assigned. Agreement with landlord is confirmed.' },
  { label: 'Ready for Construction', color: '#f59e0b', bg: 'rgba(245,158,11,0.12)', border: 'rgba(245,158,11,0.3)', desc: 'Auto-set when Café Code is assigned + LOI uploaded. Construction is now authorized.' },
      ...
      <Box sx={{ mb: 3, p: 2, borderRadius: 2, bgcolor: 'rgba(10,49,77,0.06)', border: '1px solid rgba(10,49,77,0.1)' }}>
        ...
        <Grid container spacing={1}>
          {[
            ...
            { name: 'Swiggy/Zomato Integration', desc: 'Onboard store onto delivery platforms', color: '#a855f7' },
